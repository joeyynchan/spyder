...
public class Data {
	...
	private List<Pair<String, Integer>> bluetooth_strengths;
	private String user_name;
	private String event_id;

	public Data(String user_name, String event_id, Integer time_interval,
			List<Pair<String, Integer>> strengths) {
	...
	public List<Pair<String, Integer>> getBluetooth_strengths() {
		return bluetooth_strengths;
	}

	public void setBluetooth_strengths(
			List<Pair<String, Integer>> bluetooth_strengths) {
