...
public class DbApi {
  String basePath = "https://dsp-spyder.cloud.dreamfactory.com:443/rest";
  ...
  public Resources getResources () throws ApiException {
    ...
    String path = "/dfmongohq".replaceAll("\\{format\\}","json");
  ...
  public RecordsResponse getRecordsByFilter (String table_name, String filter, Integer limit, Integer offset, String order, String fields, Boolean include_count, Boolean include_schema, String related) throws ApiException {
    ...
    // create path and map variables
    String path = "/dfmongohq/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
...
//    	  return null;
  ...
  public RecordResponse getRecord (String table_name, String id, String fields, String id_field, String id_type, String related) throws ApiException {
    ...
    // create path and map variables
    String path = "/dfmongohq/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  public RecordResponse createRecord (String table_name, String id, RecordRequest body, String fields, String id_field, String id_type, String related) throws ApiException {
    ...
    // create path and map variables
//    String path = "/dfmongohq/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    String path = "/dfmongohq/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())); //.replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    // query params
    Map<String, String> queryParams = new HashMap<String, String>();
    Map<String, String> headerParams = new HashMap<String, String>();
  ...
  public Resources getSchemas () throws ApiException {
    // create path and map variables
    String path = "/dfmongohq/_schema".replaceAll("\\{format\\}","json");
  ...
  public TableSchema describeTable (String table_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/dfmongohq/_schema/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
  ...
  public FieldSchema describeField (String table_name, String field_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/dfmongohq/_schema/{table_name}/{field_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "field_name" + "\\}", apiInvoker.escapeString(field_name.toString()));
  ...
  public Resources getStoredProcs () throws ApiException {
    // create path and map variables
    String path = "/dfmongohq/_proc".replaceAll("\\{format\\}","json");
  ...
  public StoredProcResponse callStoredProc(String procedure_name, String wrapper) throws ApiException {
    ...
    // create path and map variables
    String path = "/dfmongohq/_proc/{procedure_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "procedure_name" + "\\}", apiInvoker.escapeString(procedure_name.toString()));
